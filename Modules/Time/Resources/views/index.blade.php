...
<body>
    ...
    <div class="services-layout">
      ...
      <div class="services-grid">
        ...
        <div class="service-card reveal">
          ...
          <div class="service-desc">Programmes certifiés agréés FDFP : Pack Forfaitaire (CAPG), FNE, E-impôts, SYSCOHADA et Gestion de Paie. Devenez opérationnel en 2 mois.</div>
  ...
  <section class="experts" id="experts">
    <div class="section-header">
      ...
      <p class="section-intro reveal reveal-d2">DC-KNOWING réunit des experts-comptables diplômés, des juristes
        spécialisés et des partenaires notaires pour un accompagnement de premier rang.</p>
    </div>
    <div class="experts-grid">
      <div class="expert-card reveal">
        <div class="expert-photo-wrap">
          <img src="https://portaildck.dc-knowing.com/images/expert4.jpg" alt="Foto Noel" class="expert-photo"
        ...
        <div class="expert-bio">Expert-comptable diplômé, spécialiste de la gestion comptable et financière des
          entreprises en Côte d'Ivoire. Référent OHADA et optimisation fiscale.</div>
        <span class="expert-tag">Comptabilité · Fiscalité · Finance</span>
      </div>
      <div class="expert-card reveal reveal-d1">
        <div class="expert-photo-wrap">
          <img src="https://portaildck.dc-knowing.com/images/expert1.jpg" alt="Semeridiangone" class="expert-photo"
            onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
          <div class="expert-photo-placeholder" style="display:none">SM</div>
        </div>
        <div class="expert-name">M. Semeridiangone</div>
        <div class="expert-role">Expert-Comptable Diplômé</div>
        <div class="expert-bio">Expert-comptable et conseiller financier, spécialisé dans l'ingénierie financière, la
          structuration d'entreprise et l'accompagnement aux levées de fonds.</div>
        <span class="expert-tag">IFG · Levées de fonds · Stratégie</span>
      </div>
      <div class="expert-card reveal reveal-d2">
        <div class="expert-photo-wrap">
          <img src="https://portaildck.dc-knowing.com/images/Notaire.png" alt="Notaire Partenaire" class="expert-photo"
            onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
        ...
        <div class="expert-bio">Notaire partenaire exclusif intervenant sur les actes notariés, créations de sociétés à
          capital élevé, cessions immobilières et opérations complexes.</div>
  ...
  `;
    ...
    function validerDevis() {
      ...
      renderDevisList();
      closeModal();
      showNotification('✓ Devis créé avec succès ! Consultez-le dans "Mes Devis"', 'success');
