    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-1">📄 Détails du contrat GJGJHGJGJ</h4>
                        ...
                        <tbody>
                            @forelse($contract->avenants as $avenant)
                                <tr>
                                    ...
                                    <td>{{ $avenant->title }}</td>
                                    <td>{{ date('d/m/Y', strtotime($avenant->effective_date)) }}</td>
                                    <td>
            ...
            <form action="{{ route('company.contracts.avenant.add', $contract->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <label for="emp_name" class="form-label">Nom de l'employé</label>
                    ...
                    <div id="amountField" class="mb-3" style="display: none">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-icon-user">
                                    <select class="form-select branch_id" id="branch_id" name="branch_id">
                                        <!-- Options for branches will be populated here -->
                                    </select>
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                <div class="form-icon-user" id="department_id">
                                    ...
                                    <select class="form-select department_id" name="department_id" id="department_id" required>
                                        <!-- Options for departments will be populated here -->
                                    </select>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-icon-user designation_div">
                                    <select class="form-select" id="designation_id" name="designation_id">
                                        <!-- Options for designations will be populated here -->
                                    </select>
                                </div>
                            ...
                            <div id="end" class="form-group col-md-6">
                                <label for="contrat_end" class="form-label">Date de fin du contrat<span class="text-danger pl-1"> *</span></label>
                    ...
                    <div id="sal_cate" style="display: none;">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="category_job_id" class="form-label">Sélectionner le type de catégorie<span class="text-danger pl-1"> *</span></label>
                                <select type="text" name="category_job_id" class="form-select" id="category_job_id"> 
                                    <option value="">-- Sélectionner un type de catégorie --</option>
                                    @if (!empty($categories))   
                                        @foreach ($categories as $typejob)
                                            @if($typejob->id_secteur == $secteur_id)
                                                <option value="{{ $typejob->id }}" @if($contract->employee->categorie == $typejob->id) selected="selected" @endif>
                                                    {{ $typejob->title }}
                                                </option>
                                            @endif
                                        @endforeach
