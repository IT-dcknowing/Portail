...
<body>
  ...
  <div class="chatbot-window" id="chatbotWindow">
    <div class="chatbot-header">
      ...
      <div class="chat-header-actions">
        ...
        <button class="chatbot-close" id="chatbotClose" title="Fermer le chat" aria-label="Fermer le chat">×</button>
      </div>
    </div>
    ...
    <div class="chatbot-input-container">
      ...
      <button class="chatbot-send" title="Envoyer le message" aria-label="Envoyer le message">→</button>
    </div>
  ...
  <div class="modal-overlay" id="modalOverlay">
    <div class="modal-container">
      <div class="modal-header">
        ...
        <button class="modal-close" id="modalClose" title="Fermer la fenêtre" aria-label="Fermer la fenêtre">×</button>
      </div>
  ...
  <div class="modal-overlay" id="devisModal">
    <div class="modal-container modal-devis">
      <button class="modal-close" id="devisModalClose" title="Fermer la fenêtre" aria-label="Fermer la fenêtre">×</button>
